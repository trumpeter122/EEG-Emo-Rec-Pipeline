...
CHANNEL_PICK_OPTIONS: OptionList = OptionList(
    [
        ...
        ChannelPickOption(
            name="minimal_frontal_parietal", channel_pick=["F3", "F4", "P3", "P4"]
        ),
        ChannelPickOption(name="minimal_frontopolar", channel_pick=["Fp1", "Fp2"]),
        ChannelPickOption(
            name="minimal_temporal_augmented", channel_pick=["Fp1", "Fp2", "T7", "T8"]
        ),
        ChannelPickOption(
        ...
        ChannelPickOption(
            name="balanced_temporal", channel_pick=["F3", "F4", "T7", "T8", "P3", "P4"]
        ),
        ChannelPickOption(
